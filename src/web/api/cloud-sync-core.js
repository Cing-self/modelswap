...
const syncService = createSyncService({
  ...
  applyPulledSyncMetadata: configStore.applyPulledSyncMetadata,
  applyPulledAgentSite: configStore.applyPulledAgentSite,
  applyPulledAgentActive: configStore.applyPulledAgentActive,
  applyPulledModelOverrideField: configStore.applyPulledModelOverrideField,
  recordSyncSuccess: configStore.recordSyncSuccess,
  recordSyncObservation: configStore.recordSyncObservation,
  setSyncPlatformField: configStore.setSyncPlatformField,
  setSyncSetting: configStore.setSyncSetting,
...
module.exports = {
  ...
  applyAgentBinding: configStore.applyAgentBinding,
  setModelOverrideField: configStore.setModelOverrideField,
  ...
  recordLanListenerPort: configStore.recordLanListenerPort,
  recordSyncSuccess: configStore.recordSyncSuccess,
  recordSyncObservation: configStore.recordSyncObservation,
  removeProviderConfiguration: configStore.removeProviderConfiguration,
  rotateLanToken: configStore.rotateLanToken,
  setModelOverrideField: configStore.setModelOverrideField,
  setOnboardingDismissed: configStore.setOnboardingDismissed,
  setSyncPlatformField: configStore.setSyncPlatformField,
  setSyncSetting: configStore.setSyncSetting,
  setLanField: configStore.setLanField,
  updateUserPreferences: configStore.updateUserPreferences,
  testConnection,
  __testing: {
    shouldApplyRemoteSection,
