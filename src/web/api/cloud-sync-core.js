...
const syncService = createSyncService({
  ...
  applyPulledSyncState: configStore.applyPulledSyncState,
  importSyncPlatform: configStore.importSyncPlatform,
...
module.exports = {
  ...
  importSyncPlatform: configStore.importSyncPlatform,
  initializeLegacyConfig: configStore.initializeLegacyConfig,
  ...
  setSyncPlatformField: configStore.setSyncPlatformField,
  setSyncSetting: configStore.setSyncSetting,
  updateSettingsSync: configStore.updateSettingsSync,
