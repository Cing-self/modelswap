...
// Group normalization lives in src/vault so the CLI and the Web API share one
// implementation — duplicate copies would let CLI-created and Web-created
// groups split into near-duplicates over casing/whitespace drift.
const { normalizeVaultGroup, resolveCanonicalGroup } = require('../../vault/group-meta');
...
// normalizeVaultGroup / resolveCanonicalGroup moved to src/vault/group-meta
// (shared with the CLI); see the require at the top of this file.
